...
const Home = () => {
  ...
  // Calcular próximos do vencimento
  const proximosVencimento = useMemo(() => {
    ...
    exames.forEach(exame => {
      ...
      if (status === 'PRÓX DO VENCIMENTO' || status === 'PENDENTE') {
  ...
  const obterCorStatus = (status) => {
    if (status === 'PENDENTE') return '#ff6b6b';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            fontSize: '16px',
            margin: 0,
          }}>Treinamentos e Exames Próximos do Vencimento</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {proximosVencimento.filter(a => a.status === 'PENDENTE').length}
            </div>
            <div style={{
              fontSize: '14px',
              color: 'white',
          ...
          {proximosVencimento.length === 0 ? (
            ...
            <div style={{
              ...
              {proximosVencimento.map((alerta, idx) => {
                ...
                const corBg = alerta.status === 'PENDENTE' ? '#fff5f5' : '#fffbf0';
